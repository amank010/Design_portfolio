...
const LaptopNew = (props) => {
  ...
  const videoTexture = useVideoTexture("/assets/new_video.mp4");
  ...
  // The glass parts use "transmission", which makes three.js render the whole
  // scene a second time every frame. Plain transparent glass looks the same
  // here: the screen cover keeps its glossy highlight but lets the video
  // through, and the camera lens parts just stop refracting.
  useMemo(() => {
    for (const material of Object.values(materials)) {
      if (!material.transmission) continue;
      material.transmission = 0;
      material.needsUpdate = true;
    }
    materials["glass.002"].opacity = 0.08;
  }, [materials]);
